      ...
      {log.length > 0 && (
        <Card className="protokoll-card">
          <Card.Body>
            ...
            <Card.Title className={fileCheckStatus.class}>
              {fileCheckStatus.text}
              {downloadAvailable && (
                <span>
                  <span className="icon-tooltip">
                    <a
                      download={protokollFileName + logFileExtension}
                      className={fileCheckStatus.class + " download-icon"}
                      href={downloadUrl + logFileExtension}
                    >
                      <GoFile />
                    </a>
                  ...
                  <span className="icon-tooltip">
                    <a
                      download={protokollFileName + xtfLogFileExtension}
                      className={fileCheckStatus.class + " download-icon"}
                      href={downloadUrl + xtfLogFileExtension}
                    >
                      <GoFileCode />
                    </a>
                  ...
                  <span className="icon-tooltip">
                    <div
                      className={fileCheckStatus.class + "btn-sm download-icon"}
