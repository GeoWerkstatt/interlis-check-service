      ...
      >
        <Modal.Header>
          <Modal.Title id="contained-modal-title-vcenter">
            Informationen zum Ilicop
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <h4>Anleitung & Funktionsweise</h4>
          <p>
            Der Ilicop basiert auf dem <a href="https://www.interlis.ch/downloads/ilivalidator" title="Zum ilivalidator" target="_blank" rel="noreferrer">Ilivalidator</a> von Eisenhut informatik.
            Bei updates des Ilivaliators greift auch der Ilicop automatisch auf die jeweils aktuellste Version zu.
            Dateien, die mit dem Ilicop überprüft werden, werden auf einen Server der GeoWerstatt Gmbh (...mehr Details) hochgeladen und dort für den Validierungsprozess zwischengespeichert.
            ...
            Eine Checkliste vereinfacht das "Abarbeiten" von Fehlern. Im ILICOP steht auch die Möglichkeit "Link in Zwischenablage kopieren" zur Verfügung. Dieser Link kann kopiert werden und direkt im QGIS Plugin angegeben
          ...
          <p>
            Der ILICOP wurde von der GeoWerkstatt Gmbh in Zusammenarbeit mit der GIS Fachstelle des Kanton Solothurn als Open Source Projekt entwickelt. Der Code steht unter der Linzent (.... zu ERgänzen) im 
